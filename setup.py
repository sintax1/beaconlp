...
#
#     from beaconlp import metadata
#
# However, when we do this, we also import `beaconlp/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'beaconlp_cli = beaconlp.main:entry_point'
        ],
    }
)
